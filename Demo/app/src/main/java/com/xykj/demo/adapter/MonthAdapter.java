...
import com.xykj.demo.view.MonthView;
import com.xykj.demo.view.bean.CalendarDayModel;
import com.xykj.demo.view.bean.CalendarMonthModel;
...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.MonthHolder>
    ...
    public MonthHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(layout.item_aircalendar, parent, false);
